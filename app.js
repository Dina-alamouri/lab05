...
function multiplyAnyArray(dynamicArray) {
  let multi4=testDynamicArray[0]*testDynamicArray[1]*testDynamicArray[2]*testDynamicArray[3]*testDynamicArray[4];
  return[multi4,'The numbers '+testDynamicArray[0]+','+testDynamicArray[1]+','+testDynamicArray[2]+','+testDynamicArray[3]+','+testDynamicArray[4]+' have a product of '+multi4+'.']
  //eslint-disable-line
}
